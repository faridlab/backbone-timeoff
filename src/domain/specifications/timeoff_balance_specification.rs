//! Specifications for TimeoffBalance aggregate
//!
...
// Each predicate implements `Specification<TimeoffBalance>` and can be combined
...
//
// pub struct ActiveTimeoffBalanceSpec;
// impl Specification<TimeoffBalance> for ActiveTimeoffBalanceSpec {
//     fn is_satisfied_by(&self, e: &TimeoffBalance) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
