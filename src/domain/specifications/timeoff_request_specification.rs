//! Specifications for TimeoffRequest aggregate
//!
...
// Each predicate implements `Specification<TimeoffRequest>` and can be combined
...
//
// pub struct ActiveTimeoffRequestSpec;
// impl Specification<TimeoffRequest> for ActiveTimeoffRequestSpec {
//     fn is_satisfied_by(&self, e: &TimeoffRequest) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
