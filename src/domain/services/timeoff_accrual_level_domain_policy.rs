//! Domain policy for TimeoffAccrualLevel aggregate
//!
...
/// Domain policy for TimeoffAccrualLevel — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<TimeoffAccrualLevel>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type TimeoffAccrualLevelDomainPolicy = PermitAllPolicy<TimeoffAccrualLevel>;
