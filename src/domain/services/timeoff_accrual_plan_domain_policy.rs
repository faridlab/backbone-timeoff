//! Domain policy for TimeoffAccrualPlan aggregate
//!
...
/// Domain policy for TimeoffAccrualPlan — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<TimeoffAccrualPlan>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type TimeoffAccrualPlanDomainPolicy = PermitAllPolicy<TimeoffAccrualPlan>;
